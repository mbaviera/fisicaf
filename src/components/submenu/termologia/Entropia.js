...
export default class Entropia extends Component {
  //DEFINE VARIAVEIS
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.styleTextHead}> Variação de Entropia</Text>
          <View style={styles.styleViewFormulas}>
            <Text style={styles.styleHeadFormulas}>Entropia:</Text>
            <Text style={styles.styleHeadFormulas}>ΔS = Q/T</Text>  
            <Text style={styles.styleLegendaFormulas}>ΔS = Variação da Entropia</Text>  
