...
export default class Calorimetria extends Component {
  //DEFINE VARIAVEIS
  constructor(props) {
    super(props);
    this.state = {
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.styleTextHead}> Calor </Text>
          <View style={styles.styleViewFormulas}>
            <Text style={styles.styleHeadFormulas}>Calor sensível:</Text>
            <Text style={styles.styleHeadFormulas}>Q = m.c.Δθ</Text>  
            <Text style={styles.styleLegendaFormulas}>Q = Quantidade de Calor</Text>  
            <Text style={styles.styleLegendaFormulas}>m = Massa</Text> 
            <Text style={styles.styleLegendaFormulas}>c = Calor Específico</Text> 
            <Text style={styles.styleLegendaFormulas}>Δθ = Variação de Temperatura</Text>
            <Text> </Text>
            <Text style={styles.styleHeadFormulas}>Capacidade térmica:</Text>            
            <Text style={styles.styleHeadFormulas}>C = (Q/Δθ) = m.c </Text> 
            <Text style={styles.styleLegendaFormulas}>C = Capacidade Térmica</Text>  
            <Text style={styles.styleLegendaFormulas}>Q = Quantidade de Calor</Text> 
            <Text style={styles.styleLegendaFormulas}>Δθ = Variação de Temperatura</Text>  
            <Text style={styles.styleLegendaFormulas}>m = Massa</Text> 
            <Text style={styles.styleLegendaFormulas}>c = Calor Específico</Text> 
